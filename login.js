                ...
                <div className='row'>
                    ...
                    <div className='col-lg-3 mt-5'>
                        ...
                        <form className='form-control'>
                            <p className='text text-muted'><img src={biceps} width="90px" height="90px" />Biceps  </p>
                            <p className='text text-muted'><img src={chest} width="90px" height="90px" />Chest  </p>
                            <p className='text text-muted'><img src={abs} width="90px" height="90px" />Abs </p>
                            <p className='text text-muted'><img src={leg} width="90px" height="90px" />Leg </p>
                            <p className='text text-muted'><img src={back} width="90px" height="80px" />Back </p>
                            <p className='text text-muted'><img src={delt} width="80px" height="90px" />Shoulder </p>
                        </form>
                    </div>
                </div>
            </div>
